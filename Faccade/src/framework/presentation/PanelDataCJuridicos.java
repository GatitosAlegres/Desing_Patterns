...
import business.model.tables.TableCJ;
 ...
 * @author GEORGE
 */
public class PanelDataCJuridicos extends javax.swing.JPanel {

    /**
     * Creates new form PanelDataCJuridicos
     */
    public PanelDataCJuridicos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Clientes Juridicos");
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 750, 210));
    ...
    private void formAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_formAncestorAdded
        try {
            jTable1.setModel(new TableCJ(FileClientes.getListClientesJuridico()));
        } catch (Exception e) {
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Navigation.toPanel(Navigation.REGISTRO_LECTURA_CJ);
